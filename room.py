...
class Room:
    def __init__(self, room_number: int, room_type: str, room_price: float, guest_name: str = "") -> None:
    ...
    def get_room_price(self) -> float:
        return self._room_price

    def set_room_price(self, room_price: float) -> None:
        self._room_price = room_price

    # Backwards compatibility alias
    set_price = set_room_price
    ...
    def __str__(self) -> str:
        ...
        return (
            ...
            f"Price: {self._room_price}, Status: {status}"
        )